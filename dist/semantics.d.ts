 ...
 * Signed: EyosiyasJ
 */
export type CanonicalKey = "generic_name" | "brand_name" | "strength" | "form" | "category" | "expiry_date" | "batch_no" | "pack_contents" | "on_hand" | "unit_price" | "coo" | "sku" | "manufacturer" | "notes" | "requires_prescription" | "is_controlled" | "storage_conditions" | "purchase_unit" | "pieces_per_unit" | "unit" | "reserved";
